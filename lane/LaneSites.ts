...
class LaneSites {
    ...
    public createLeftSourceInnerHtml() {
    ...
    public createLeftDestinationInnerHtml() {
    ...
    public createRightSourceInnerHtml() {
    ...
    public createRightDestinationInnerHtml() {
