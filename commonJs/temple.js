...
function openDialog(str){
    landmarkDialog = showInputDialougeExt('Loading Info',250,250,"document.forms['data_form']",'#dialog_form');
}


function saveMapLandmark(){
}

function showInputDialougeExt(title,m_height,m_width,form,dialougeFormId){
    var dialog = null;
