var TimerTask = /** @class */ (function () {
    ...
    TimerTask.getMenuDataFromJson = function () {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                Temple.menuListGlobal = JSON.parse(this.responseText).Menu;
            }
        };
        xhttp.open("GET", "jsonData/menuData.json", true);
        xhttp.send();
    };
    ...
    TimerTask.getGloabalMenuJsonList = function () {
        ...
        xmlHttp.open("POST", this.url_global_menu_list, true);
        // var params = "action=something";
        xmlHttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xmlHttp.send();
    };
    ...
    TimerTask.url_global_menu_list = "http://203.197.197.16:9680//LocTracker/TempleDashboardData.jsp?action_p=global_menu_list";
    return TimerTask;
}());
